...
const cafes = require("./coffee.json")
...
app.get("/coffee/:id", (req, res) => {
    ...
    else res.status(404).send({ message: "No se encontró un cafe con ese id" })
})
...
app.put("/coffee/:id", (req, res) => {
    ...
    if (id != cafe.id)
        return res
            .status(400)
            .send({
                message: "El id del parámetro no coincide con el del café recibido",
            });
